...
public class SysVipExample {
    ...
    public static class Criteria extends GeneratedCriteria {
        ...
        public Criteria multiColumnOrClause(List<String> fieldsList, List<Object> valueList) {
            String or = "";
            if (valueList.size() == fieldsList.size() && fieldsList.size() > 0) {
                or = "(";
                if (valueList.get(0).getClass().equals(Integer.class)) {
                    or += fieldsList.get(0) + " = " + valueList.get(0);
                } else if (valueList.get(0).getClass().equals(String.class)) {
                    or += fieldsList.get(0) + " = '" + valueList.get(0) + "'";
                }

                for (int i = 1; i < valueList.size() && valueList.size() == fieldsList.size(); i++) {
                    if (valueList.get(i).getClass().equals(Integer.class)) {
                        or += " OR " + fieldsList.get(i) + " = " + valueList.get(i);
                    } else if (valueList.get(i).getClass().equals(Integer.class)) {
                        or += " OR " + fieldsList.get(i) + " = '" + valueList.get(i) + "'";
                    }
                }
                or += ")";
        ...
        public Criteria multiColumnOrClauseLike(List<String> fieldsList, List<String> valueList) {
            String or = "";
            if (valueList.size() == fieldsList.size() && fieldsList.size() > 0) {
                or = "(";
                or += fieldsList.get(0) + " like '%" + valueList.get(0) + "%'";

                for (int i = 1; i < valueList.size() && valueList.size() == fieldsList.size(); i++) {
                    or += " OR " + fieldsList.get(i) + " like '%" + valueList.get(i) + "%'";
                }
                or += ")";
            }
            addCriterion(or);
